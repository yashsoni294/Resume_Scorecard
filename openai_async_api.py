        ...
        try:
            ...
            if file.content_type == "application/zip" or file_extension == "zip":
                ...
                for file_name in extracted_files:
                    ...
                    if file_name.endswith(".pdf"):
                        with open(file_path, "rb") as pdf_file:
                            response_data[original_name] = {"content": read_pdf(pdf_file), "file_path": file_path}
                    
                    # Process TXT files
                    elif file_name.endswith(".txt"):
                        with open(file_path, "rb") as txt_file:
                            response_data[original_name] = {"content": read_txt(txt_file), "file_path": file_path}

                    elif file_name.endswith(".docx"):
                        try:
                            with open(file_path, "rb") as docx_file:
                                response_data[original_name] = {"content": read_docx(docx_file), "file_path": file_path}
                        except Exception as e:
                ...
                if file_extension == "pdf":
                    with open(file_path, "rb") as pdf_file:
                        response_data[file_name] = {"content": read_pdf(pdf_file)}
                
                elif file_extension == "txt":
                    with open(file_path, "rb") as txt_file:
                        response_data[file_name] = {"content": read_txt(txt_file)}
                
                elif file_extension == "docx":
                    try:
                        with open(file_path, "rb") as docx_file:
                            response_data[file_name] = {"content": read_docx(docx_file)}
                    except Exception as e:
