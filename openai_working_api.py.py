...
async def upload_files(job_description: str, files: list[UploadFile] = File(...)):
    ...
    for filename in response_data:
        ...
        resume_response = conversation_resume({"resume_text": response_data[filename]["content"]})
        # print(resume_response.content)
        response_data[filename]["key_feature"] = resume_response
        ...
        response_data[filename]["score"] = score_response
